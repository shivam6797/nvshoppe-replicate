...
//       return SingleChildScrollView(
//         child: ListView.builder(
//           itemCount: _paymentTypeList.length + 1,
//           scrollDirection: Axis.vertical,
//           physics: NeverScrollableScrollPhysics(),
//           shrinkWrap: true,
//           itemBuilder: (context, index) {
...
//                           Card(
//                             shape: RoundedRectangleBorder(
//                               side: _iswalletSelected == true
//                                   ? BorderSide(
//                                       color: MyTheme.accent_color, width: 2.0)
//                                   : BorderSide(
...
//                 : Padding(
//                     padding: const EdgeInsets.only(bottom: 8.0),
//                     child: buildPaymentMethodItemCard(index - 1),
//                   );
//           },
//         ),
//       );
...
//                 (_paymentTypeList[index].payment_type == "wallet_system" ||
//                     _paymentTypeList[index].payment_type == "cash_payment") ||
//             _paymentTypeList[index].payment_type_key == "wallet"
//         ? GestureDetector(
//             child: Container(),
//             onDoubleTap: () {},
//           )
