...
class _SplashState extends State<Splash> {
  ...
  Future<Widget> loadFromFuture() async {
    ...
    return Future.value(SearchCity());
  }
  ...
  checkCity() async {
    try {
      ...
      var cityId = await prefs.getString("cityId");
      var cityName = await prefs.getString("cityName");
      log("cITY id nAME => ${cityId.toString() + cityName}");
      hasShopId = shopId != null ? true : false;
    } catch (e) {
      hasShopId = false;
    }
  }
  ...
  Widget build(BuildContext context) {
    return CustomSplashScreen(
      ...
      navigateAfterSeconds: hasShopId == true ? Main() : SearchCity(),
